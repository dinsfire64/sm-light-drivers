...
void mm_setDDRBassLight(int a, int b) { light_state.bass = b; }

void mm_setDDRAllOn() { light_state.AllOn(); }

void mm_setDDRAllOff() { light_state.AllOff(); }
...
bool mm_setKB(bool val) { return true; }

void mm_setBlueLED(unsigned char value) {}

void mm_setMMOutputReports(unsigned char a, unsigned char b, unsigned char c,
                           unsigned char d) {}

unsigned char mm_turnON(unsigned char set, int bit) { return 0; }

unsigned char mm_turnOFF(unsigned char set, int bit) { return 0; }
