...
#include <windows.h>
    ...
    bool EXPORT Pac64SetLEDStatesRandom(DWORD /*id*/, const bool * /*states*/, DWORD /*length*/) { return true; }
    bool EXPORT Pac64SetLEDIntensities(DWORD /*id*/, const BYTE * /*intensities*/, DWORD /*length*/) { return true; }
    bool EXPORT Pac64SetLEDIntensity(DWORD /*id*/, DWORD /*port*/, BYTE /*intensity*/) { return true; }
    bool EXPORT Pac64SetLEDFadeTime(DWORD /*id*/, DWORD /*fadeTime*/) { return true; }
    bool EXPORT Pac64SetLEDFlashSpeeds(DWORD /*id*/, const BYTE * /*speeds*/, DWORD /*length*/) { return true; }
    bool EXPORT Pac64SetLEDFlashSpeed(DWORD /*id*/, DWORD /*port*/, BYTE /*speed*/) { return true; }

    // ---- Scripting ----
    bool EXPORT Pac64StartScriptRecording(DWORD /*id*/) { return true; }
    bool EXPORT Pac64StopScriptRecording(DWORD /*id*/) { return true; }
    bool EXPORT Pac64SetScriptStepDelay(DWORD /*id*/, DWORD /*delay*/) { return true; }
    ...
    bool EXPORT PacProgramUHid(DWORD /*id*/, const void * /*data*/, DWORD /*length*/) { return true; }
    bool EXPORT PacSetServoStik4Way(DWORD /*id*/) { return true; }
    bool EXPORT PacSetServoStik8Way(DWORD /*id*/) { return true; }

    bool EXPORT USBButtonConfigurePermanent(DWORD /*id*/, DWORD /*color*/) { return true; }
    bool EXPORT USBButtonConfigureTemporary(DWORD /*id*/, DWORD /*color*/) { return true; }
    bool EXPORT USBButtonConfigureColor(DWORD /*id*/, DWORD /*color*/) { return true; }
